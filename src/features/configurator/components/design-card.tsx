...
export function DesignCard({ design, isSelected, onSelect }: DesignCardProps) {
  ...
  return (
    <button className="h-full min-w-0 text-left" onClick={onSelect} type="button">
      <Card
        className={cn(
      ...
      >
        <div className="relative flex aspect-[1.02] items-center justify-center bg-[radial-gradient(circle_at_top,_rgba(56,189,248,0.12),_transparent_52%),linear-gradient(180deg,#ffffff_0%,#f4f7fb_100%)] p-4 sm:p-5 lg:p-6">
          <div
            className={cn(
        ...
        <div className="flex flex-1 flex-col justify-between gap-4 p-4 sm:p-5">
          <div className="space-y-3">
            <div className="space-y-2">
              <h3 className="line-clamp-2 font-heading text-base font-semibold leading-7 text-foreground lg:text-lg">
                {design.name}
              </h3>
              <div>
                {isSelected ? (
